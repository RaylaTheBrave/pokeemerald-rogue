...
SINGLE_BATTLE_TEST("Membrane increases Bug-type move damage", s16 damage)
{
    u32 move;
    u16 ability;

    PARAMETRIZE { move = MOVE_TACKLE; ability = ABILITY_LEVITATE; }
    PARAMETRIZE { move = MOVE_TACKLE; ability = ABILITY_MEMBRANE; }
    PARAMETRIZE { move = MOVE_X_SCISSOR; ability = ABILITY_LEVITATE; }
    PARAMETRIZE { move = MOVE_X_SCISSOR; ability = ABILITY_MEMBRANE; }
    PARAMETRIZE { move = MOVE_BUG_BUZZ; ability = ABILITY_LEVITATE; }
    PARAMETRIZE { move = MOVE_BUG_BUZZ; ability = ABILITY_MEMBRANE; }
